        ...
        <div class="g-doc">
            ...
            <div class="xg2_mn_bg">
                <div class="xg2_mn">
                    <div class="xg2_mn_tt">
                        <h3>验证账号</h3>
                        <h3 style="color:#d21e1e;">修改密码</h3>
                        <h3 style="margin:0;">修改成功</h3>
                        <div class="cb"></div>
                    </div>
                    <img src="<?php echo base_url() ?>static/home/image/xiugai_2_tt.png" class="tt_img"/>
                    <div class="xg2_mn_fm">
                        <form id="repassword_form">
                            <p>新密码</p><input name="password" class="xg2_mn_fm_ipt" type="password"/><br/>
                            <p>确认新密码</p><input name="repassword" class="xg2_mn_fm_ipt" type="password"/><br/>
                            <input id="repassword_button" type="button" class="xg2_mn_fm_next" value="下一步"/>
                        </form>
                    </div>
                </div>
            </div>
