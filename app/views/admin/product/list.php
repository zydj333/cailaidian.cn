...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <a href="<?php echo base_url('admin_product/add'); ?>"><li class="click"><span><img src="/static/admin/images/t01.png" /></span>添加</li></a>
                </ul>
                <ul class="seachform">
                        ...
                        <?php foreach ($list as $key => $value): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url(); ?>admin_product_items/index/<?php echo $value->id; ?>" class="tablelink">收益设置</a>&nbsp;&nbsp;
                                    <a href="<?php echo base_url(); ?>admin_product/edit/<?php echo $value->id; ?>" class="tablelink">修改</a>&nbsp;&nbsp;
                                    <a href="javascript:void(0);" class="tablelink"  onclick="return del(<?php echo $value->id; ?>);"> 删除</a></td>
                            </tr> 
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
...
<script type="text/javascript">
            ...
            function del(id) {
                $.ajax({
                    url: '/admin_product/del/' + id + '/' + Math.random(),
                    success: function(data) {
                        art.dialog({
                            lock: true,
                            background: '#600', // 背景色
                            ...
                            //cancel: true,
                            ok: function() {
                                location.href = "/admin_product/index";
                            }
                        });
                    },
                    cache: false
                    ...
                    success: function(data) {
                        ...
                        if (data.flag == 0) {
                            ...
                            $.each(data.error, function(key, values) {
                                ...
                                str+='<a href="/admin_product_items/index/' + values.id + '" class="tablelink">收益设置</a>&nbsp;&nbsp;';
