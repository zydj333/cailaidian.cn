    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getPageUrl(nowpage) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/admin_point_recycle/ajaxList/" + Math.random(),
            ...
            function recycle(id) {
                $.ajax({
                    url: '/admin_point_recycle/recycle/' + id + '/' + Math.random(),
                    success: function(data) {
                                location.href = "/admin_point_recycle/index";
                            }
                        });
            }
        </script>
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="/admin_point/index">商品回收站</a></li>
            </ul>
        </div>
        <div class="rightinfo">
            <ul class="seachform">
