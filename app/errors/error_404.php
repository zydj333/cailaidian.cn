    ...
    <body>
        <div class="g-doc">
            ...
            <div class="denglu_main_bg">
                <h2 style=" font-size: 24px; padding-top: 100px;padding-bottom: 100px; width: 100%; text-align: center;">您所访问的页面未找的：404 NOT FOUND！<?php if(isset($_SERVER['HTTP_REFERER'])&&$_SERVER['HTTP_REFERER']!=''):?><a href="<?php echo $_SERVER['HTTP_REFERER'];?>">返回</a> 或者 <?php endif;?><a href="<?php echo base_url();?>">首页</a></h2>
